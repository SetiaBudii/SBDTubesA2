...
<?php 
    if (!isset($_SESSION['username']) && !isset($_SESSION['role'])) {
        ...
        exit;
    }else if(isset($_SESSION['username']) && isset($_SESSION['role']) && $_SESSION['role'] != "PANITIA"){
        header('Location:'. BASEURL .'/home/index');
        exit;
    }
?>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/panitia/dashboard">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Dashboard</span></a>
        </li>
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/panitia/seleksi">
        ...
        <hr class="sidebar-divider my-0">
        <li class="nav-item">
            <a class="nav-link" href="<?= BASEURL; ?>/panitia/ManajemenData">
                <i class="fas fa-file-invoice"></i>
                <span>ManajemenData</span></a>
        </li>
