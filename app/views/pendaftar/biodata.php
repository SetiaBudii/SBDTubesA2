            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Perhatikan!</strong> Masukan Data Sesuai Dengan Data Diri !
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                    <h1 class="h3 mb-0 text-gray-800">Biodata Siswa</h1><br>                   
                </div>
                ...
                <form action="<?= BASEURL; ?>/pendaftar/updateBiodata" method="post">
                    <div class="row mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Asal STLP">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                        <label for="exampleInputEmail1">Kab. /Kota Tempat Lahir</label>
                        <input type="text" class="form-control" placeholder="Kab. /Kota Tempat Lahir">
                        </div>
                        <div class="col">
